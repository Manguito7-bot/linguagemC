...
class Game:
    ...
    def __init__(self):
        ...
        self.flower = Obj("assets/flower1.png", random.randrange(0, 320), 200)
    ...
    def update(self):
        ...
        self.move_bg()
        self.spider.animation("spider", 8, 5)
        self.flower.animation("flower", 8, 3)
        self.bee.animation("bee", 2, 5)
        self.move_spiders()
        self.move_flower()
    ...
    def move_flower(self):
        ...
        if self.flower.sprite.rect[1] > 640:
            ...
            self.flower = Obj("assets/flower1.png", random.randrange(0, 320), -100)
